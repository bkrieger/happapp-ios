...
#define HAPP_BARTINT_COLOR [UIColor colorWithRed:0.667 green:0.016 blue:0.439 alpha:.65] /*#aa0470 with alpha*/
...
#define PUSH_REGISTRATION_SUCCEEDED_KEY @"pushRegistrationSucceeded"
